        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h4 class="mb-0"><i class="fas fa-cart-plus me-2"></i>Ajouter une nouvelle commande</h4>
            ...
            <div class="card mt-4 border-left-warning">
                <div class="card-body">
                    ...
                    <ul class="mb-0">
                        <li>Vérifiez la disponibilité des menus avant de confirmer une commande</li>
                        <li>Contactez le client pour confirmer les détails importants</li>
                        <li>Calculez correctement le montant total en fonction de la quantité</li>
