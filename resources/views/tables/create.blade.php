        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <h4 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Ajouter une nouvelle table</h4>
                    ...
                    <form action="{{ route('tables.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="numero" id="numero" 
                                           ...
                                           value="{{ old('numero') }}" min="1" required>
                                    @error('numero')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="capacite" id="capacite" 
                                           ...
                                           value="{{ old('capacite', 4) }}" min="1" max="20" required>
                                    @error('capacite')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i>Enregistrer la table
                            </button>
                        </div>
                    </form>
                </div>
