...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-edit me-2"></i>Modifier le menu</h1>
        ...
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-clipboard-list me-2"></i>Modification du menu</h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('menus.update', $menu->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="nom" id="nom" class="form-control" value="{{ old('nom', $menu->nom) }}" required>
                        </div>
                        
                        <div class="form-group mb-3">
                            <label for="description" class="form-label"><i class="fas fa-align-left me-1"></i> Description :</label>
                            <textarea name="description" id="description" class="form-control" rows="3">{{ old('description', $menu->description) }}</textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" name="date_menu" id="date_menu" class="form-control" value="{{ old('date_menu', $menu->date_menu->format('Y-m-d')) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="prix" class="form-label"><i class="fas fa-euro-sign me-1"></i> Prix (FCFA) :</label>
                                    <input type="number" step="0.01" name="prix" id="prix" class="form-control" value="{{ old('prix', $menu->prix) }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="type" id="type" class="form-control" required>
                                ...
                                <option value="brunch" {{ old('type', $menu->type) == 'brunch' ? 'selected' : '' }}>Brunch</option>
                                <option value="dejeuner" {{ old('type', $menu->type) == 'dejeuner' ? 'selected' : '' }}>Déjeuner</option>
                                <option value="diner" {{ old('type', $menu->type) == 'diner' ? 'selected' : '' }}>Dîner</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            @if($menu->image_path)
                                <div class="mt-2">
                                    ...
                                    <div>
                                        <img src="{{ asset('storage/' . $menu->image_path) }}" alt="Image du menu" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i>Mettre à jour le menu
                            </button>
                        </div>
                    </form>
                </div>
