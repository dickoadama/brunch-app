...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-user-plus me-2"></i>Ajouter un nouveau client</h1>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('clients.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="nom" id="nom" class="form-control" value="{{ old('nom') }}" required placeholder="Ex: Dupont">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="prenom" class="form-label"><i class="fas fa-user me-1"></i> Prénom :</label>
                                    <input type="text" name="prenom" id="prenom" class="form-control" value="{{ old('prenom') }}" required placeholder="Ex: Jean">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="email" name="email" id="email" class="form-control" value="{{ old('email') }}" required placeholder="Ex: jean.dupont@email.com">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="telephone" id="telephone" class="form-control" value="{{ old('telephone') }}" placeholder="Ex: 01 23 45 67 89">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="adresse" id="adresse" class="form-control" rows="3" placeholder="Ex: 123 Rue de la Paix, 75000 Paris">{{ old('adresse') }}</textarea>
                        </div>
