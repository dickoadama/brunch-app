        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-warning text-white d-flex justify-content-between align-items-center">
                    <h4 class="mb-0"><i class="fas fa-edit me-2"></i>Modifier la catégorie</h4>
                    ...
                    <form action="{{ route('categories.update', $categorie->id) }}" method="POST">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            ...
                            <button type="submit" class="btn btn-warning">
                                <i class="fas fa-sync-alt me-1"></i>Mettre à jour la catégorie
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="card mt-4 border-left-warning">
                <div class="card-body">
                    ...
                    <ul class="mb-0">
                        <li>Assurez-vous que le nom de la catégorie est clair et représentatif</li>
                        <li>Mettez à jour la description si nécessaire</li>
                        <li>Vérifiez que les modifications n'affectent pas l'organisation existante</li>
                        <li>Consultez les recettes associées avant de faire des changements majeurs</li>
                    </ul>
                </div>
            </div>
        </div>
