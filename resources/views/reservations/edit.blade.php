        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-warning text-white d-flex justify-content-between align-items-center">
                    <h4 class="mb-0"><i class="fas fa-calendar-edit me-2"></i>Modifier la réservation</h4>
                    ...
                    <form action="{{ route('reservations.update', $reservation->id) }}" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" name="date_reservation" id="date_reservation" 
                                           ...
                                           value="{{ old('date_reservation', $reservation->date_reservation->format('Y-m-d\TH:i')) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="nombre_personnes" id="nombre_personnes" 
                                           ...
                                           value="{{ old('nombre_personnes', $reservation->nombre_personnes) }}" min="1" max="50" required>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            ...
                            <button type="submit" class="btn btn-warning">
                                <i class="fas fa-sync-alt me-1"></i>Mettre à jour la réservation
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="card mt-4 border-left-warning">
                <div class="card-body">
                    ...
                    <ul class="mb-0">
                        <li>Informez le client de tout changement de réservation</li>
                        <li>Vérifiez la disponibilité avant de modifier les dates</li>
